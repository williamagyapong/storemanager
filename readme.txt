...
4. Launch a browser(chrome or mozilla recommended)
...
6. Register an administrator to start using the application
7. The adminstrator must register a minimum of two personnels, one as a stock manager
